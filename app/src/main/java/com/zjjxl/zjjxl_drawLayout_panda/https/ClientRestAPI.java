package com.zjjxl.zjjxl_drawLayout_panda.https;
...
import com.zjjxl.zjjxl_drawLayout_panda.beans.BindCardIsBean;
...
import com.zjjxl.zjjxl_drawLayout_panda.beans.LoginBean;
...
import com.zjjxl.zjjxl_drawLayout_panda.beans.QueryCZCity;
import com.zjjxl.zjjxl_drawLayout_panda.beans.QueryUserInfo;
import com.zjjxl.zjjxl_drawLayout_panda.beans.SessioIdBean;
import com.zjjxl.zjjxl_drawLayout_panda.beans.SmsCode;
import com.zjjxl.zjjxl_drawLayout_panda.beans.Bean_Person;
import com.zjjxl.zjjxl_drawLayout_panda.beans.queryUserInfoByUserMobileBean;
import com.zjjxl.zjjxl_drawLayout_panda.beans.regAppUser;
...
//    接口地址： /foreign/registerAppUser.jspx
    ...
    @FormUrlEncoded
    @POST("register/index/sendVerificationCode.jspx")
    @Headers("Content-Type:application/x-www-form-urlencoded; charset=utf-8")
    ...
    @FormUrlEncoded
    @POST("/register/index/validate.jspx")
    @Headers("Content-Type:application/x-www-form-urlencoded; charset=utf-8")
...
//    @FormUrlEncoded
    ...
    @Headers("Content-Type:application/x-www-form-urlencoded; charset=utf-8")
    Call<queryUserInfoByUserMobileBean> resetUserPassword(@Field("userMid") String userMid,
                                                          @Field("newPassword") String newPassword
    );
...
//
    ...
    ///foreign/rechargeRecordSave.jspx 充值记录添加
     ...
     */
    @FormUrlEncoded
    @POST("/foreign/rechargeRecordSave.jspx")
    @Headers("Content-Type:application/x-www-form-urlencoded; charset=utf-8")
    Call<Bean_BaseCard> rechargeRecordSave(@Field("orderCode") String orderCode,
                                           @Field("tradeNo") String tradeNo,
                                           @Field("cardNo") String cardNo,
                                           @Field("state") int state,
                                           @Field("phone") String phone,
                                           @Field("userId") String userId,
                                           @Field("userMid") String userMid,
                                           @Field("tradeAmount") double tradeAmount,
                                           @Field("circleState") int circleState,
    ...
    //userId 用户id/userMid 用户mid/phone 用户手机号
    //（默认为空读取所有）
    @FormUrlEncoded
    @POST("/foreign/rechargeRecordList.jspx")
    @Headers("Content-Type:application/x-www-form-urlencoded; charset=utf-8")
    Call<ChargeMoneyRecordbean> rechargeRecordList(@Field("phone") String phone,
                                                   @Field("userId") String userId,
                                                   @Field("userMid") String userMid
    );

    //订单状态更新
    //state:订单状态/circleState:圈存状态
    @FormUrlEncoded
    @POST("/foreign/rechargeRecordUpdate.jspx")
    @Headers("Content-Type:application/x-www-form-urlencoded; charset=utf-8")
    Call<ChargeMoneyRecordbean> rechargeRecordUpdatestate(@Field("orderCode") String orderCode,
                                                          @Field("state") int state
    );
    ...
    @POST("/foreign/rechargeRecordUpdate.jspx")
    @Headers("Content-Type:application/x-www-form-urlencoded; charset=utf-8")
    Call<ChargeMoneyRecordbean> rechargeRecordUpdatecircleState(@Field("orderCode") String orderCode,
                                                                @Field("circleState") int circleState
    );
