...
public class RightsActivityH5 extends AppCompatActivity {

    WebView mRight_webview;
    private String TAG = "RightsActivityH5";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rights_h5);
        initView();
        loadDate();
    }

    private void loadDate() {
        mRight_webview.loadUrl("https://mp.weixin.qq.com/s/Xmkd8XY3lYKgvqreYQUe4Q");
