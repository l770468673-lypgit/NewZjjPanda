...
import com.zjjxl.zjjxl_drawLayout_panda.utils.AppStatus;
...
public class WelcomeActivit extends XLBaseActivity implements View.OnClickListener {
    ...
    public final Runnable toSplashActivity = new Runnable() {
        @Override
        public void run() {
            Intent intent = new Intent(WelcomeActivit.this, Main_DrawerLayout.class);
    ...
    protected void onResume() {
        ...
        if (string != null) {
            ...
            mHandler.postDelayed(toSplashActivity, 1000);
        }else {
